...
public class linked {
    ...
    public static void main(String args[]) {
        linked linkedList = new linked();    // 연결 리스트 생성
        String str = "wed";
        ...
        linkedList.printList(); //출력
        
        System.out.println(linkedList.searchNode(str).getData()); // wed 찾음
        
        linkedList.deleteNode(linkedList.searchNode(str).getData()); //제거
        linkedList.printList();// 출력
